...
Trainer.destroy_all
Trainer.create(name: "Ash", level: 20, img_url: "https://img.pokemondb.net/artwork/charmander.jpg")
Trainer.create(name: "Missy", level: 30, img_url: "https://img.pokemondb.net/artwork/squirtle.jpg")
